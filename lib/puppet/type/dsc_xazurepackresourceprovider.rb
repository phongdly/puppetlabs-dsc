...
Puppet::Type.newtype(:dsc_xazurepackresourceprovider) do
  ...
  newparam(:dsc_adminauthenticationuser) do
    ...
    validate do |value|
      ...
      provider.validate_MSFT_Credential("AdminAuthenticationUser", value)
    end
  end
  ...
  newparam(:dsc_tenantauthenticationuser) do
    ...
    validate do |value|
      ...
      provider.validate_MSFT_Credential("TenantAuthenticationUser", value)
    end
  end
  ...
  newparam(:dsc_usageauthenticationuser) do
    ...
    validate do |value|
      ...
      provider.validate_MSFT_Credential("UsageAuthenticationUser", value)
    end
  end
  ...
  newparam(:dsc_healthcheckauthenticationuser) do
    ...
    validate do |value|
      ...
      provider.validate_MSFT_Credential("HealthCheckAuthenticationUser", value)
    end
  end
  ...
  newparam(:dsc_notificationauthenticationuser) do
    ...
    validate do |value|
      ...
      provider.validate_MSFT_Credential("NotificationAuthenticationUser", value)
    end
  end
